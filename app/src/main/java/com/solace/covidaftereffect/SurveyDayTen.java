...
public class SurveyDayTen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_survey_day_ten, container, false);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child("Day10");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SurveyDayEleven surveyDayEleven = new SurveyDayEleven();
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container,surveyDayEleven);
                transaction.commit();
            }
        });
        return view;
