...
public class SurveyDayFourteen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_survey_day_fourteen, container, false);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child("Day14");
