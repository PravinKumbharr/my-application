...
public class TestDayThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_test_day_three, container, false);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child("Day3");
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId){
                    case R.id.queFourRadio0:
                        ...
                        databaseReference.child("Que4").setValue("Often");
                        break;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SurveyDayFour surveyDayFour = new SurveyDayFour();
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container,surveyDayFour);
                transaction.commit();
            }
        });
        return view;
    ...
    public static TestDayThree newInstance(String text) {

        TestDayThree f = new TestDayThree();
        Bundle b = new Bundle();
