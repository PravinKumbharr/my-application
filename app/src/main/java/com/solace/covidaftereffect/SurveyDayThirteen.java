...
public class SurveyDayThirteen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_survey_day_thirteen, container, false);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child("Day13");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SurveyDayFourteen surveyDayFourteen = new SurveyDayFourteen();
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container,surveyDayFourteen);
                transaction.commit();
            }
        });
        return view;
