...
public class SurveyDayTwelve extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_survey_day_twelve, container, false);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Users").child("Day12");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SurveyDayThirteen surveyDayThirteen = new SurveyDayThirteen();
                FragmentTransaction transaction=getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment_container,surveyDayThirteen);
                transaction.commit();
            }
        });
        return view;
